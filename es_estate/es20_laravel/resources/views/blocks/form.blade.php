<section class="vh-100" style="background-color: #b1a3a6;">
      ...
      <div class="col col-xl-10">
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0">
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center" {{-- style="background-color: #b1a3a6;" --}}>
                ...
                <form action="{{ url("/{$pagina}") }}" method="POST">
                  ...
                  @if ($azione == 'login')
                    <div class="pt-1 mb-4">
                      ...
                      {{-- <a data-mdb-button-init data-mdb-ripple-init class="btn btn-dark btn-lg btn-block" href="login">Login</a> --}}
                    </div>
                  @endif

                  <div class="pt-1 mb-4">
                      <button data-mdb-button-init data-mdb-ripple-init class="btn btn-dark btn-lg btn-block" type="submit">Registrati</button>
                      {{-- <a data-mdb-button-init data-mdb-ripple-init class="btn btn-dark btn-lg btn-block" href="register">Registrati</a> --}}
                  </div>
