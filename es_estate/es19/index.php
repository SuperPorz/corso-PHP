<?php
    ...
    include_once 'inc/cambia_tema.php';
    ...
    // scrittura tema se settato
    if (isset($_POST['azione']) && $_POST['azione'] == 'cambia_tema' && 
        isset($_POST['tema'])) {
            $tema = Tema\memorizza_tema_scelto($_POST['tema']);
    }
    // lettura tema
    $tema = Tema\leggi_tema();
    echo 'tema scelto: ' . $tema;
