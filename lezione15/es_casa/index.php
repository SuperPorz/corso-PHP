<?php
    ...
    //controllers
    $cAuto = new cAuto($tab_auto);
    $cParcheggio = new cParcheggio($tab_parcheggio);
    $cSosta = new cSosta($tab_sosta);

    //views 
    $vAuto = new vAuto($tab_auto);
    $vParcheggio = new vParcheggio($tab_parcheggio);
    $vSosta = new vSosta($tab_sosta, $tab_auto, $tab_parcheggio);
